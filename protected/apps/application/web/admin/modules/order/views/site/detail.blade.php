...
@section('content')
        ...
        <div class="col-md-6 col-sm-12">
            <div class="portlet green-meadow box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{yUrl(['/survey/site/detail','uuid'=>$order_data['source_uuid']])}}" target="_blank"
                           class="btn btn-success btn-sm">查看调研</a>
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="row static-info">
                        ...
                        <div class="col-md-8 value"> {{ $survey['name'] or '' }}
                            <span>(微信呢称：<a href="{{yUrl(['/user/lists/detail','uid'=>$userdata['uid']])}}"
                                           target="_blank">{{$userdata['realname']}}</a>)</span>
                        </div>
                    </div>
                    <div class="row static-info">
                    ...
                    <div class="row static-info">
                        ...
                        <div class="col-md-8 value"><span
                                    class="label label-danger"> {{ gOrderStatus($order_data['order_status']) }}</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="ship-content" style="display:none">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control input-inline input-medium ship_code"
                       value="{{$order_data['ship_code']}}" placeholder="快递单号">
            </div>
        </div>
    </div>
