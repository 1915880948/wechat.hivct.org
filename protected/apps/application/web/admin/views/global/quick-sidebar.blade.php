        ...
        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
          ...
          <ul class="media-list list-items">
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar3.jpg')}}" alt="...">
            ...
            <li class="media">
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar1.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar4.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar2.jpg')}}" alt="...">
              <div class="media-body">
          ...
          <ul class="media-list list-items">
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar6.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar7.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar8.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar9.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar10.jpg')}}" alt="...">
              <div class="media-body">
            ...
            <li class="media">
              ...
              <img class="media-object" src="{{yStatic('assets/layouts/layout/img/avatar11.jpg')}}" alt="...">
              <div class="media-body">
        ...
        <div class="page-quick-sidebar-item">
          <div class="page-quick-sidebar-chat-user">
            ...
            <div class="page-quick-sidebar-chat-user-messages">
              <div class="post out">
                <img class="avatar" alt="" src="{{yStatic('assets/layouts/layout/img/avatar3.jpg')}}"/>
                <div class="message">
              ...
              <div class="post in">
                <img class="avatar" alt="" src="{{yStatic('assets/layouts/layout/img/avatar2.jpg')}}"/>
                <div class="message">
            ...
            <li>
              <div class="col1">
                <div class="cont">
                  ...
                  <div class="cont-col2">
                    <div class="desc"> You have 4 pending tasks. <span class="label label-sm label-warning "> Take action
            ...
            <li>
              <div class="col1">
                <div class="cont">
                  ...
                  <div class="cont-col2">
                    <div class="desc"> New order received with <span class="label label-sm label-success"> Reference Number: DR23923 </span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li>
              <div class="col1">
                <div class="cont">
                  ...
                  <div class="cont-col2">
                    <div class="desc"> Web server hardware needs to be upgraded. <span class="label label-sm label-warning"> Overdue </span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li>
              <div class="col1">
                <div class="cont">
                  ...
                  <div class="cont-col2">
                    <div class="desc"> Web server hardware needs to be upgraded. <span class="label label-sm label-default "> Overdue </span>
                    </div>
                  </div>
                </div>
              </div>
