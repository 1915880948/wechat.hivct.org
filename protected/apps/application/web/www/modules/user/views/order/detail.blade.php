...
@section('content')
  ...
  <div class="weui-cells">
    <div class="weui-media-box__bd">
      <h4 class="weui-media-box__title">收货信息</h4>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">收货人：</label></div>
        <div class="weui-cell__bd">{{ $orderData['address_contact'] }}</div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">电话：</label></div>
        <div class="weui-cell__bd">{{ $orderData['address_mobile'] }}</div>
      </div>
      <div class="weui-cell">
        <div class="weui-cell__hd"><label class="weui-label">地址：</label></div>
        <div class="weui-cell__bd">{{ $orderData['address_detail'] }}</div>
      </div>
    </div>
  </div>

  @if($orderData['ship_code'] != "")
    <div class="weui-cells">
      <div class="weui-media-box__bd">
        <h4 class="weui-media-box__title">快递信息</h4>
        <div class="weui-cell">
          <div class="weui-cell__hd"><label class="weui-label">快递公司：</label></div>
          <div class="weui-cell__bd">{{ $orderData['ship_name'] }}</div>
        </div>
        <div class="weui-cell">
          <div class="weui-cell__hd"><label class="weui-label">快递单号：</label></div>
          <div class="weui-cell__bd">{{ $orderData['ship_code'] }}</div>
        </div>
      </div>
    </div>
  @endif
