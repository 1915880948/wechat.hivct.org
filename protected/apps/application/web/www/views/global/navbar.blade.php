<div class="weui-tabbar">
  <a href="{{yUrl(['/site'])}}" class="weui-tabbar__item weui-bar__item--on"> <span class="weui-badge" style="position: absolute;top: -.4em;right: 1em;">8</span>
    <div class="weui-tabbar__icon">
      <i class="iconfont icon-shouye-xianxing"></i>
    </div>
    <p class="weui-tabbar__label">首页</p>
  </a> <a href="{{yUrl(['/check/fastflow'])}}" class="weui-tabbar__item">
    <div class="weui-tabbar__icon">
