...
namespace console\modules\tools\generators\model;
...
{
    public $db                         = 'db';
    public $ns                         = 'application\models';
    public $tableName;
    public $tableClassPrefix           = "";
    public $modelClass;
    ...
    public $queryNs        = 'application\models';
    public $queryClass;
    ...
    public $searchNs       = 'application\models\search';
    public $searchClass;
    /**
     * common
     */
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns'                         => 'This is the namespace of the ActiveRecord class to be generated, e.g., <code>application\models</code>',
            ...
            'queryNs'                    => 'This is the namespace of the ActiveQuery class to be generated, e.g., <code>application\models</code>',
    ...
    public function generate()
    {
        ...
        foreach($this->getTableNames() as $tableName){
            ...
            if($searchClassName){
                $params = [
                    'modelClassName'   => $this->ns . "\\" . $modelClassName,
...
//        $model = new $this->modelClass();
    ...
    protected function generateClassName($tableName, $useSchemaName = null)
    {
        ...
        return $this->classNames[$fullTableName] = Inflector::id2camel($schemaName . ($this->tableClassPrefix != "" ? ucfirst($this->tableClassPrefix)."_" : "_")
                                                                       . $className, '_');
    }
    ...
    {
        $queryClassName = $this->searchClass;
        if(empty($queryClassName) || strpos($this->tableName, '*') !== false){
            $queryClassName = $modelClassName . 'Search';
        }
