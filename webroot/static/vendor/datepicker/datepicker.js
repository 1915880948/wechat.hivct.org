...
!function ($){
    ...
    var Datepicker=function (element,options){
        ...
        if(this.isInput){
            this.element.on({
                focus: $.proxy(this.show,this),//blur: $.proxy(this.hide, this),
    ...
    Datepicker.prototype={
        constructor: Datepicker,show: function (e){
            ...
            this.picker.css({
                top: offset.top+this.height,left: offset.left
            });
                ...
                switch(target[0].nodeName.toLowerCase()){
                    ...
                    case 'span':
                        ...
                        if(this.viewMode!==0){
                            ...
                            this.element.trigger({
                                type: 'changeDate',date: this.date,viewMode: DPGlobal.modes[this.viewMode].clsName
                            });
                        }
                        this.showMode(-1);
                        this.fill();
    ...
    var DPGlobal={
        ...
        formatDate: function (date,format){
            var val={
                d: date.getDate(),m: date.getMonth()+1,yy: date.getFullYear().toString().substring(2),yyyy: date.getFullYear()
            };
