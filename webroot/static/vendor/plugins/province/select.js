...
function Selected() {
    this.param = {
        ...
        return new GetHelper(this.info.provId);
    }, this.city = function () {
        return new GetHelper(this.info.cityId);
    }, this.area = function () {
        return new GetHelper(this.info.areaId);
        ...
        info.prov.change(function () {
            ...
            elem.html('<option value="' + $(this).val().substr(0, 2) + '0000">' + ob.param.tips + '</option>');
            appendOption(elem, provDatas);
            //为区或者县最近数据()
            info.area.html('<option value="' + $(this).val().substr(0, 2) + '0000">' + ob.param.tips + '</option>');
        ...
        info.city.change(function () {
            ...
            cityDatas = getDatas($(this).val());
            info.area.html('<option value="' + $(this).val().substr(0, 4) + '00">' + ob.param.tips + '</option>');
            if ($(this).val().substr(2, 4) !== "0000") {
                appendOption(info.area, cityDatas);
            }
